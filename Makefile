...
PROGRAMS=mi_mkfs leer_sf escribir leer permitir truncar mi_mkdir mi_touch mi_chmod mi_ls mi_stat filesys mi_link mi_escribir mi_cat mi_rm mi_rmdir prueba_cache_tabla mi_escribir_varios#simulacion verificacion
OBJS=$(SOURCES:.c=.o)
